...
struct MessageItem: Identifiable {
    ...
    var videoURL: String?
    var audioURL: String?
    var audiouDuration: TimeInterval?
    ...
    static let stubMessages: [MessageItem] = [
        MessageItem(id: UUID().uuidString, isGroupChat: false, text: "Hello", type: .text, ownerUid: "3", timeStamp: Date(), thumbnailUrl: nil),
        ...
        MessageItem(id: UUID().uuidString, isGroupChat: false, text: "Play this Video", type: .video, ownerUid: "5", timeStamp: Date(), thumbnailUrl: nil),
...
extension MessageItem {
    init(id: String, isGroupChat: Bool, dict: [String: Any]) {
        ...
        self.audiouDuration = dict[.audioDuration] as? TimeInterval ?? nil
        
        print("Initialized MessageItem with id: \(id), type: \(self.type), text: \(self.text), thumbnailUrl: \(String(describing: self.thumbnailUrl))")
